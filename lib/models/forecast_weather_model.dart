...
//
//     final focastWeatherModel = focastWeatherModelFromJson(jsonString);

import 'dart:convert';

FocastWeatherModel focastWeatherModelFromJson(String str) =>
    FocastWeatherModel.fromJson(json.decode(str));

String focastWeatherModelToJson(FocastWeatherModel data) =>
    json.encode(data.toJson());

class FocastWeatherModel {
  Location? location;
  Current? current;
  Forecast? forecast;
  ...
  factory FocastWeatherModel.fromJson(Map<String, dynamic> json) =>
      FocastWeatherModel(
